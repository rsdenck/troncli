...
"github.com/rsdenck/nux/internal/console"
	...
	"github.com/rsdenck/nux/internal/modules/process"
...
var treeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table.SetTitle("NUX - ÁRVORE DE PROCESSOS")
...
var openFilesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle(fmt.Sprintf("NUX - ARQUIVOS ABERTOS (PID %d)", pid))
...
var processPortsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle(fmt.Sprintf("NUX - PORTAS DO PROCESSO (PID %d)", pid))
...
var listeningCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle("NUX - PORTAS EM ESCUTA (LISTENING)")
		table.SetHeaders([]string{"PORT/PROTOCOL"})
