...
var auditLoginsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table.SetTitle("NUX - HISTÓRICO DE LOGINS (24H)")
...
var auditSudoersCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle("NUX - USUÁRIOS PRIVILEGIADOS (SUDO/WHEEL/ROOT)")
...
var auditFileChangesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle("NUX - ALTERAÇÕES EM ARQUIVOS (24H)")
...
var auditCommandsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		table := console.NewBoxTable(os.Stdout)
		table.SetTitle("NUX - HISTÓRICO DE COMANDOS (SUDO/LOGS)")
