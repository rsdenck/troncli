...
"github.com/rsdenck/nux/internal/console"
	...
	"github.com/rsdenck/nux/internal/modules/plugin"
	"github.com/spf13/cobra"
)

var pluginCmd = &cobra.Command{
	Use:   "plugin",
	Short: "Gerenciar plugins do NUX",
	Long:  `Instalar, listar e remover plugins (scripts ou binários) do NUX.`,
}
...
var pluginListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		table.SetTitle("NUX - PLUGINS INSTALADOS")
...
Exemplos:
  nux plugin install arch
  nux plugin install https://example.com/my-plugin.sh
  nux plugin install ./local-script.py`,
